<?php $__env->startSection('title', 'Soal UAS'); ?>
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white border border-blue-200 rounded-2xl p-4 mb-6 flex flex-wrap gap-4 items-center justify-between shadow-sm">
        ...
        <div class="flex flex-wrap gap-3 text-sm text-gray-600">
            ...
            <span id="answered-badge" class="bg-green-100 text-green-700 px-3 py-1 rounded-lg font-semibold">
                <span id="answered-count"><?php echo e($answers->count()); ?></span>/20 dijawab
            </span>
        </div>
    </div>
    ...
    <?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if($currentSection !== $question->section): ?>
            <?php $currentSection = $question->section; $sec = $sections[$currentSection]; ?>
            <div class="mt-8 mb-4">
        ...
        <div class="question-card bg-white border rounded-2xl p-5 mb-4 shadow-sm transition-all duration-200
            ...
            <div class="ml-12">
                ...
                ><?php echo e($answers[$question->id] ?? ''); ?></textarea>
    ...
    <div class="mt-8 bg-white border-2 border-gray-200 rounded-2xl p-6 text-center shadow-sm">
        ...
        <div class="flex flex-col sm:flex-row gap-3 justify-center">
            <a href="<?php echo e(route('ujian.selesai')); ?>"
...
function updateTimer() {
    ...
    const remaining = Math.max(0, <?php echo e(\App\Models\ExamSession::EXAM_DURATION); ?> - current);
    ...
    if (remaining === 0) {
        ...
        window.location.href = '<?php echo e(route("ujian.selesai")); ?>';
    }
}
...
setInterval(() => {
    ...
    const current = elapsed + delta;
    fetch('<?php echo e(route("ujian.sync-timer")); ?>', {
        method: 'POST',
        headers: {
...
async function saveAnswer(questionId) {
    ...
    try {
        const res = await fetch('<?php echo e(route("ujian.jawab")); ?>', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': CSRF,
...
window.addEventListener('beforeunload', () => {
    const delta = Math.floor((Date.now() - timerStart) / 1000);
    const current = elapsed + delta;
    navigator.sendBeacon('<?php echo e(route("ujian.sync-timer")); ?>',
