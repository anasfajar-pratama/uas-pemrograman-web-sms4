...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Sistem UAS'); ?> — Pemrograman Web</title>
...
<body class="bg-gray-50 min-h-screen font-sans">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-14">
                <div class="flex items-center gap-3">
                    ...
                    <span class="font-bold text-sm sm:text-base">Test Pemrograman</span>
                </div>
                <div class="flex items-center gap-4">
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <div class="flex items-center gap-2 text-sm">
                            <span class="hidden sm:block opacity-80"><?php echo e(auth()->user()->name); ?></span>
                            <span class="text-xs bg-blue-600 px-2 py-0.5 rounded-full capitalize"><?php echo e(auth()->user()->role); ?></span>
                        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 mt-4">
        <?php $__currentLoopData = ['success'=>'green','error'=>'red','warning'=>'yellow','info'=>'blue']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type=>$color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if(session($type)): ?>
                <div class="mb-3 px-4 py-3 bg-<?php echo e($color); ?>-50 border border-<?php echo e($color); ?>-200 text-<?php echo e($color); ?>-800 rounded-lg text-sm flex items-start gap-2">
...
<?php /**PATH F:\uas-pemrograman-web\resources\views/layouts/app.blade.php ENDPATH**/ ?>