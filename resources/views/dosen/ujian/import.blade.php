...
<div class="max-w-3xl mx-auto">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <h1 class="text-xl font-bold text-gray-900">Import Soal — {{ $exam->name }}</h1>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border p-6">
        ...
        <form method="POST" action="{{ route('dosen.ujian.soal.import.store', $exam->id) }}" enctype="multipart/form-data">
            @csrf
