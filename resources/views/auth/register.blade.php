            ...
            <form method="POST" action="{{ route('register') }}" id="registerForm">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}"
                           ...
                           class="w-full px-4 py-2.5 border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-green-500 @error('name') border-red-400 bg-red-50 @else border-gray-300 @enderror">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nim" value="{{ old('nim') }}"
                           ...
                           class="w-full px-4 py-2.5 border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-green-500 @error('nim') border-red-400 bg-red-50 @else border-gray-300 @enderror">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}"
                           ...
                           class="w-full px-4 py-2.5 border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-green-500 @error('email') border-red-400 bg-red-50 @else border-gray-300 @enderror">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="password" placeholder="Min. 6 karakter"
                           class="w-full px-4 py-2.5 border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-green-500 @error('password') border-red-400 bg-red-50 @else border-gray-300 @enderror">
